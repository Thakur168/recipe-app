    ...
    <footer>
      <div className="container">
        <section className="footer_content">
          <div className="row">
            ...
            <div className="content col text-center">
              ...
              <ul>
                <li>
                  <p>Priya Thakur (8958634)</p>
                </li>
                <li>
                  <p>Hari Karnan (8925421)</p>
                </li>
                <li>
                  <p>Vijay Prakash (8962818)</p>
                </li>
                <li>
                  <p>Venkat Reddy (8982817)</p>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="footer_bottom text-center">
          ...
          <p>
            &copy; <span id="date"></span> 2025 The Recipe Vault - Group 5. All
            Rights Reserved
          </p>
        </section>
      </div>
